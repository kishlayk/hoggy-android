...
public class BluetoothDemo extends Activity {
    ...
    class ListItemClicked implements AdapterView.OnItemClickListener
    {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            try {
				...
				/*	BluetoothDevice device = bluetoothAdapter.getRemoteDevice(bdDevice.toString());
    ...
    class ListItemClickedonPaired implements AdapterView.OnItemClickListener
    {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            try {
                BluetoothDevice device = bluetoothAdapter.getRemoteDevice(bdDevice.toString());
                final UUID SERIAL_UUID = UUID.fromString(String.valueOf(bdDevice.getUuids()));
                BluetoothSocket socket = device.createRfcommSocketToServiceRecord(SERIAL_UUID);
                socket.connect();
			/*	Boolean removeBonding = removeBond(bdDevice);
				...
				Log.i("Log", String.valueOf(bdDevice.getUuids()));*/
            } catch (Exception e) {
            ...
            if(BluetoothDevice.ACTION_FOUND.equals(action)){
                ...
                if (BluetoothDevice.ACTION_BOND_STATE_CHANGED.equals(action)) {
                    ...
                    if (device.getBondState() == BluetoothDevice.BOND_BONDED) {
                        ...
                        Log.v("yes_connected","is_connected "+msg);
                        // CONNECT
                    }
